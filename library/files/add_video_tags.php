...
$test = substr($test, 1);
$result = mysqli_query($conn, "SELECT Src FROM video WHERE Url = '$test'");
while($row = mysqli_fetch_array($result)){
$Src = $row['Src'];
$result2 = mysqli_query($conn, "SELECT Tag FROM video_tags WHERE Video_url = '$Src' AND Pending = 0 ORDER BY Number ASC");
echo 'Tags: <strong>';
...
$insert = ("INSERT INTO video_tags (Tag, Video_url, Pending) VALUES ('$Tag3', '$Src', '$Pending')");
